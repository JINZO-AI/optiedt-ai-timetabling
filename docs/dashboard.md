...
| **Current phase** | **Phase 4 — the web interface. IN PROGRESS, M4 of 6 complete.** Generation screen and the four timetable views run end to end against the real solver. Milestone table in the Phase 4 roadmap block below |
...
| **Next task** | Phase 4 **M5** — the comparison screen (FR-14, FR-15), which ticks the third acceptance criterion. ⚠️ Its **dominance signal** needs **C-14**; **C-12(a)** blocks M6's grid cell model |
