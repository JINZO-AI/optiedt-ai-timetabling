...
| **Current phase** | **Phase 4 — the web interface. IN PROGRESS, M3 of 6 complete.** The API is complete for this phase and the generation screen runs end to end against the real solver. Milestone table in the Phase 4 roadmap block below |
...
| **Next task** | Phase 4 **M4** — the four timetable views (FR-7, FR-18): by teacher, group, room and laboratory. ⚠️ Settle **C-14** before M5's dominance signal and **C-12(a)** before M6's grid cell model |
