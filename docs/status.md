...
| | |
|---|---|
| **Current phase** | **Phase 4 — the web interface. In progress, M4 of 6 complete.** The API is complete for this phase; the generation screen and the four timetable views run end to end against the real solver. Milestone table in [`docs/dashboard.md`](dashboard.md) |
...
| **Next step** | Phase 4 **M5** — the comparison screen (FR-14, FR-15). ⚠️ Its dominance signal needs **C-14**; **C-12(a)** blocks M6's grid cell model |
