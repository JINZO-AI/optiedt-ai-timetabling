...
✅ **All twenty open questions are resolved (C-1 to C-21, no C-10). C-9 — the last — closed on
2026-08-11**, taking FR-6, FR-10 and FR-18 to `✓` and the count to **21 of 25**. ⚠️ **Six of the twenty
were project decisions from repository evidence rather than supervisor answers**, each recording what
would reverse it. **C-15 was
