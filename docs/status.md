...
| | |
|---|---|
| **Current phase** | **Phase 5 — pre-analysis in-app, diagnosis, authentication, run record. IN PROGRESS, M3 of 6 done.** Phase 4 closed 2026-08-01: six milestones and a closing audit. Milestone table in [`docs/dashboard.md`](dashboard.md) |
...
| **Next step** | **Phase 5 M4 — authentication and rights (FR-11)**. M1 landed FR-12 with both bounds; M2 landed FR-8 and resolved C-17; M3 landed FR-19 against real PostgreSQL. Then M5 publication, M6 the closing audit |
